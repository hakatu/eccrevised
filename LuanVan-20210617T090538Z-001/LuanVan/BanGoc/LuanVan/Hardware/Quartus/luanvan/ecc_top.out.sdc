## Generated SDC file "ecc_top.out.sdc"
...
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {din}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {mode[0]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {mode[1]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {mode[2]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {rst}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {start}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {test_num}]
...
set_output_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {dout}]
set_output_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {status[0]}]
set_output_delay -add_delay  -clock [get_clocks {clk}]  0.000 [get_ports {status[1]}]
