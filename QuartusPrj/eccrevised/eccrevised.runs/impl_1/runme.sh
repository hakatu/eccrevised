...
HD_PWD='D:/Paper/ECC Revised/QuartusPrj/eccrevised/eccrevised.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ecc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ecc_top.tcl -notrace
