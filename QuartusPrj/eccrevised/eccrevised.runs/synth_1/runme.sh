...
HD_PWD='D:/Paper/ECC Revised/QuartusPrj/eccrevised/eccrevised.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecc_top.tcl
