...
wire               flag_en = flag == 2'b10;

always @(posedge clk)
    begin
    if (rst)                flag <= 2'b00;
    else if (naf_ranvld)    flag <= 2'b00;
    else if (flag[1])       flag  <= 2'b00;
    else                    flag <= flag_inc;
    end
